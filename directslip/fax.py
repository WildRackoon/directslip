...
class Fax:
    ...
    # def to_string(self):
    #     # TODO REPR
    #     res = self.get_str_content()
    #     if self.image:
    #         res.append(str(self.image))
    #     return "\n".join(res)
...
class Printer:
    def __init__(self):
        self.usb_backend = usb_get_backend()
        self.p = escpos.printer.Usb(0x04b8, 0x0202, usb_args={"backend": self.usb_backend}, profile="TM-T88V")
